...
#' @noRd
com_atproto_sync_get_blob <- function(
  did,
  cid,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_sync_get_blocks <- function(
  did,
  cids,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_sync_get_checkout <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_get_head <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_get_host_status <- function(
  hostname,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_get_latest_commit <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_get_record <- function(
  did,
  collection,
  rkey,
  .token = NULL,
...
#' @noRd
com_atproto_sync_get_repo <- function(
  did,
  since = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_sync_get_repo_status <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_list_blobs <- function(
  did,
  since = NULL,
  limit = NULL,
  cursor = NULL,
...
#' @noRd
com_atproto_sync_list_hosts <- function(
  limit = NULL,
  cursor = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_sync_list_repos <- function(
  limit = NULL,
  cursor = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_sync_list_repos_by_collection <- function(
  collection,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_sync_notify_of_update <- function(
  hostname,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_sync_request_crawl <- function(
  hostname,
  .token = NULL,
  .return = c("json", "resp")
) {
