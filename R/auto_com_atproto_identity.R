...
#' @noRd
com_atproto_identity_get_recommended_did_credentials <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_identity_refresh_identity <- function(
  identifier,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_identity_request_plc_operation_signature <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_identity_resolve_did <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_identity_resolve_handle <- function(
  handle,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_identity_resolve_identity <- function(
  identifier,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_identity_sign_plc_operation <- function(
  token = NULL,
  rotationKeys = NULL,
  alsoKnownAs = NULL,
...
#' @noRd
com_atproto_identity_submit_plc_operation <- function(
  operation,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_identity_update_handle <- function(
  handle,
  .token = NULL,
  .return = c("json", "resp")
) {
