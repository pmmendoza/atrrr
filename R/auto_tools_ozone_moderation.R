...
#' @noRd
tools_ozone_moderation_emit_event <- function(
  event,
  subject,
  createdBy,
...
#' @noRd
tools_ozone_moderation_get_event <- function(
  id,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_get_record <- function(
  uri,
  cid = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
tools_ozone_moderation_get_records <- function(
  uris,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_get_repo <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_get_reporter_stats <- function(
  dids,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_get_repos <- function(
  dids,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_get_subjects <- function(
  subjects,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_moderation_query_events <- function(
  types = NULL,
  createdBy = NULL,
  sortDirection = NULL,
  createdAfter = NULL,
...
#' @noRd
tools_ozone_moderation_query_statuses <- function(
  queueCount = NULL,
  queueIndex = NULL,
  queueSeed = NULL,
  includeAllUserRecords = NULL,
  ...
  reportedBefore = NULL,
  reviewedAfter = NULL,
  hostingDeletedAfter = NULL,
  hostingDeletedBefore = NULL,
  hostingUpdatedAfter = NULL,
  hostingUpdatedBefore = NULL,
  hostingStatuses = NULL,
  reviewedBefore = NULL,
  includeMuted = NULL,
  onlyMuted = NULL,
  reviewState = NULL,
...
#' @noRd
tools_ozone_moderation_search_repos <- function(
  term = NULL,
  q = NULL,
  limit = NULL,
  cursor = NULL,
