...
#' @noRd
tools_ozone_set_add_values <- function(
  name,
  values,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
tools_ozone_set_delete_set <- function(
  name,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_set_delete_values <- function(
  name,
  values,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
tools_ozone_set_get_values <- function(
  name,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
tools_ozone_set_query_sets <- function(
  limit = NULL,
  cursor = NULL,
  namePrefix = NULL,
  sortBy = NULL,
...
#' @noRd
tools_ozone_set_upsert_set <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
