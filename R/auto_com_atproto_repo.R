...
#' @noRd
com_atproto_repo_apply_writes <- function(
  repo,
  writes,
  validate = NULL,
  swapCommit = NULL,
...
#' @noRd
com_atproto_repo_create_record <- function(
  repo,
  collection,
  record,
  rkey = NULL,
...
#' @noRd
com_atproto_repo_delete_record <- function(
  repo,
  collection,
  rkey,
  swapRecord = NULL,
...
#' @noRd
com_atproto_repo_describe_repo <- function(
  repo,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_repo_get_record <- function(
  repo,
  collection,
  rkey,
  cid = NULL,
...
#' @noRd
com_atproto_repo_import_repo <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_repo_list_missing_blobs <- function(
  limit = NULL,
  cursor = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_repo_list_records <- function(
  repo,
  collection,
  limit = NULL,
  cursor = NULL,
...
#' @noRd
com_atproto_repo_put_record <- function(
  repo,
  collection,
  rkey,
  record,
...
#' @noRd
com_atproto_repo_upload_blob <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
