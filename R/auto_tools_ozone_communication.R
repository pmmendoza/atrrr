...
#' @noRd
tools_ozone_communication_create_template <- function(
  name,
  contentMarkdown,
  subject,
  lang = NULL,
...
#' @noRd
tools_ozone_communication_delete_template <- function(
  id,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_communication_list_templates <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
tools_ozone_communication_update_template <- function(
  id,
  name = NULL,
  lang = NULL,
