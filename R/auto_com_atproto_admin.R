...
#' @noRd
com_atproto_admin_delete_account <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_admin_disable_account_invites <- function(
  account,
  note = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_disable_invite_codes <- function(
  codes = NULL,
  accounts = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_enable_account_invites <- function(
  account,
  note = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_get_account_info <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_admin_get_account_infos <- function(
  dids,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_admin_get_invite_codes <- function(
  sort = NULL,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_admin_get_subject_status <- function(
  did = NULL,
  uri = NULL,
  blob = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_admin_search_accounts <- function(
  email = NULL,
  cursor = NULL,
  limit = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_admin_send_email <- function(
  recipientDid,
  content,
  senderDid,
  subject = NULL,
...
#' @noRd
com_atproto_admin_update_account_email <- function(
  account,
  email,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_update_account_handle <- function(
  did,
  handle,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_update_account_password <- function(
  did,
  password,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_update_account_signing_key <- function(
  did,
  signingKey,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_admin_update_subject_status <- function(
  subject,
  takedown = NULL,
  deactivated = NULL,
  .token = NULL,
