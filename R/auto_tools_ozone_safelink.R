...
#' @noRd
tools_ozone_safelink_add_rule <- function(
  url,
  pattern,
  action,
  reason,
...
#' @noRd
tools_ozone_safelink_query_events <- function(
  cursor = NULL,
  limit = NULL,
  urls = NULL,
  patternType = NULL,
...
#' @noRd
tools_ozone_safelink_query_rules <- function(
  cursor = NULL,
  limit = NULL,
  urls = NULL,
  patternType = NULL,
...
#' @noRd
tools_ozone_safelink_remove_rule <- function(
  url,
  pattern,
  comment = NULL,
  createdBy = NULL,
...
#' @noRd
tools_ozone_safelink_update_rule <- function(
  url,
  pattern,
  action,
  reason,
