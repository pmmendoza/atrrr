...
#' @noRd
com_atproto_server_activate_account <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_check_account_status <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_confirm_email <- function(
  email,
  token,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_server_create_account <- function(
  handle,
  email = NULL,
  did = NULL,
  inviteCode = NULL,
...
#' @noRd
com_atproto_server_create_app_password <- function(
  name,
  privileged = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_server_create_invite_code <- function(
  useCount,
  forAccount = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' Create invite codes.
#' @noRd
com_atproto_server_create_invite_codes <- function(
  codeCount,
  useCount,
  forAccounts = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_server_create_session <- function(
  identifier,
  password,
...
#' @noRd
com_atproto_server_deactivate_account <- function(
  deleteAfter = NULL,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_server_delete_account <- function(
  did,
  password,
  token,
  .token = NULL,
...
#' @noRd
com_atproto_server_describe_server <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_get_account_invite_codes <- function(
  includeUsed = NULL,
...
#' @noRd
com_atproto_server_get_service_auth <- function(
  aud,
  exp = NULL,
  lxm = NULL,
  .token = NULL,
...
#' @noRd
com_atproto_server_get_session <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_list_app_passwords <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_refresh_session <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_request_account_delete <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_request_email_confirmation <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_request_email_update <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
com_atproto_server_request_password_reset <- function(
  email,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_server_reserve_signing_key <- function(
  did = NULL,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_server_reset_password <- function(
  token,
  password,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
com_atproto_server_revoke_app_password <- function(
  name,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
com_atproto_server_update_email <- function(
  email,
