...
#' @noRd
app_bsky_notification_get_preferences <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
app_bsky_notification_get_unread_count <- function(
  priority = NULL,
  seenAt = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
app_bsky_notification_list_activity_subscriptions <- function(
  limit = NULL,
  cursor = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
app_bsky_notification_list_notifications <- function(
  reasons = NULL,
  limit = NULL,
  priority = NULL,
  cursor = NULL,
...
#' @noRd
app_bsky_notification_put_activity_subscription <- function(
  subject,
...
#' @noRd
app_bsky_notification_put_preferences <- function(
  priority,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' Set notification-related preferences for an account. Requires auth.
#' @noRd
app_bsky_notification_put_preferences_v2 <- function(
  chat = NULL,
  follow = NULL,
  like = NULL,
  likeViaRepost = NULL,
  ...
  reply = NULL,
  repost = NULL,
  repostViaRepost = NULL,
  starterpackJoined = NULL,
  subscribedPost = NULL,
  unverified = NULL,
  verified = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_notification_register_push <- function(
  serviceDid,
  token,
  platform,
  appId,
...
#' @noRd
app_bsky_notification_update_seen <- function(
  seenAt,
  .token = NULL,
  .return = c("json", "resp")
) {
