...
#' @noRd
tools_ozone_team_add_member <- function(
  did,
  role,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
tools_ozone_team_delete_member <- function(
  did,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
tools_ozone_team_list_members <- function(
  q = NULL,
  disabled = NULL,
  roles = NULL,
  limit = NULL,
...
#' @noRd
tools_ozone_team_update_member <- function(
  did,
  disabled = NULL,
  role = NULL,
  .token = NULL,
