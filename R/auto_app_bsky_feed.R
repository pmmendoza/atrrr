...
#' @noRd
app_bsky_feed_describe_feed_generator <- function(
  .token = NULL,
  .return = c("json", "resp")
) {
  make_request(
...
#' @noRd
app_bsky_feed_get_actor_feeds <- function(
  actor,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_actor_likes <- function(
  actor,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_author_feed <- function(
  actor,
  limit = NULL,
  cursor = NULL,
  filter = NULL,
...
#' @noRd
app_bsky_feed_get_feed <- function(
  feed,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_feed_generator <- function(
  feed,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
app_bsky_feed_get_feed_generators <- function(
  feeds,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
app_bsky_feed_get_feed_skeleton <- function(
  feed,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_likes <- function(
  uri,
  cid = NULL,
  limit = NULL,
  cursor = NULL,
...
#' @noRd
app_bsky_feed_get_list_feed <- function(
  list,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_post_thread <- function(
  uri,
  depth = NULL,
  parentHeight = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_get_posts <- function(
  uris,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' @noRd
app_bsky_feed_get_quotes <- function(
  uri,
  cid = NULL,
  limit = NULL,
  cursor = NULL,
...
#' @noRd
app_bsky_feed_get_reposted_by <- function(
  uri,
  cid = NULL,
  limit = NULL,
  cursor = NULL,
...
#' @noRd
app_bsky_feed_get_suggested_feeds <- function(
  limit = NULL,
  cursor = NULL,
  .token = NULL,
  .return = c("json", "resp")
...
#' @noRd
app_bsky_feed_get_timeline <- function(
  algorithm = NULL,
  limit = NULL,
  cursor = NULL,
  .token = NULL,
...
#' @noRd
app_bsky_feed_search_posts <- function(
  q,
  sort = NULL,
  since = NULL,
  until = NULL,
