...
#' @noRd
tools_ozone_verification_grant_verifications <- function(
  verifications,
  .token = NULL,
  .return = c("json", "resp")
) {
...
#' List verifications
#' @noRd
tools_ozone_verification_list_verifications <- function(
  cursor = NULL,
  limit = NULL,
  createdAfter = NULL,
  createdBefore = NULL,
...
#' @noRd
tools_ozone_verification_revoke_verifications <- function(
  uris,
  revokeReason = NULL,
  .token = NULL,
  .return = c("json", "resp")
